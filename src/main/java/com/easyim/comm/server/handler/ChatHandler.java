    ...
    protected void channelRead0(ChannelHandlerContext ctx, ChatRequestMessage msg) throws Exception {
        ...
        if (Objects.equals(ServerConstants.DialogType.SINGLE_CHAT.getCode(), dialog.getDialogType())) {
            ...
            if (friendChannel == null) {
                ...
                friendChannel.writeAndFlush(new ChatResponseMessage(SnowflakeIDGenerator.generateID(), msg.getSenderId(), msg.getReceiverId(), msg.getContent(), msg.getNow()));
            }
        } else {
            // 推送群组
            ...
            if (groupChannel == null) {
                ...
                groupChannel.writeAndFlush(new ChatResponseMessage(SnowflakeIDGenerator.generateID(), msg.getSenderId(), msg.getReceiverId(), msg.getContent(), msg.getNow()));
            }
        }
    }
